 ...
 *
 * Клик по самой собаке ловится координатно в js/dialogue/dialogue.js (там же
 * рядом живёт пасхалка "долгое нажатие на собаку", различающая короткий
 * клик и удержание) — у #characterContainer постоянно pointer-events:none
 * (см. css/dog.css), поэтому обычный addEventListener на самой картинке
