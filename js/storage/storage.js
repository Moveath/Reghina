...
//
// Сверку с сервером (п.1-3 в комментарии у reconcileWithServer) запускаем
// сразу вслед за этим, но только если код на этом устройстве УЖЕ БЫЛ —
// для только что созданного кода сравнивать ещё не с чем (профиль пустой
// с обеих сторон), а сама сверка — это лишний сетевой запрос, который
