...
/* ===== Диалог 17 (speech — нейтральная) ===== */
    ...
    /* ===== Диалог 31 (speech — нейтральная) =====
       Переход к иконке «Чат». Закрываем «О проекте», если он был открыт. */
    {
        type: "speech",
        text: "Этот чат будет связывать напрямую с Егором. Можешь написать что-нибудь сюда, а я обязательно ему передам, чтобы он прочитал. Можешь писать сюда по любому поводу.",
        emotion: "neutral",
        highlightTarget: "chatButton",
        closeSettingsPanel: true
    },

    /* ===== Диалог 32 (speech — нейтральная) =====
       Переход к иконке «Уведомления». */
    {
        type: "speech",
        text: "А здесь как раз таки наоборот — ты сможешь получать сообщения и письма от Егора, которые он оставляет тебе.",
        emotion: "neutral",
        highlightTarget: "notificationButton"
    },

    /* ===== Диалог 33 (speech — растерянная) =====
       В этот момент на иконке уведомлений загорается непрочитанное (см.
       showNotificationBadge). Ждём клика — открывается «письмо» от Егора
       (само закрывается через пару секунд, см. settings.js). */
    {
        type: "speech",
        text: "Смотри! Кажется, Егор написал тебе что-то. Давай прочитаем.",
        emotion: "confused",
        waitForClick: "notificationButton",
        hintText: "нажми на уведомления",
    ...
    /* ===== Диалог 43 (speech — растерянная/задумчивая) =====
       Последний диалог основной линии — завершает интро. */
    {
        type: "speech",
    ...
    /* ===== Прощальный диалог-ответвление (после Диалога 9, ветка «Пока нет») =====
       Не часть основной нумерованной линии — сюда переходят только через next:43
