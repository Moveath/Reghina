...
const introDialogueLines = [
    ...
    {
        type: "speech",
        text: "Егор рассказал мне совсем немного. По его словам, это место создавалось для одного особенного человека. И, насколько я понял... этот человек сейчас смотрит на экран.",
        emotion: "happy"
    },
    ...
    {
        type: "thought",
        text: "Почему он не дал мне имени...",
        emotion: "confused"
    },
...
/* ===== Диалог 17 (speech — нейтральная) ===== */
    ...
    {
        type: "speech",
        text: "Например, темы. Если однажды тебе надоест текущий вид сайта, можешь всё поменять буквально за пару секунд.Кажется, Егор слишком долго выбирал темы для этого места.Можешь попробовать",
        emotion: "neutral",
    ...
    {
        type: "speech",
        text: "Егор сказал, что ты можешь добавить свою песню или музыку, и потом он попытается её добавить. В будущем ты сможешь выбирать её, чтобы играла именно она.",
        emotion: "happy",
    ...
    {
        type: "speech",
        text: "А это мой дневник, сюда я записываю все свои мысли раз в несколько дней.",
        emotion: "happy",
